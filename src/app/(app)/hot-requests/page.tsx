    ...
    <div className="min-h-screen pb-20 md:pb-8">
      <div className="sticky top-0 z-30 bg-dark-900/80 backdrop-blur-lg border-b border-dark-700 px-6 py-4">
        <div className="max-w-2xl mx-auto flex items-center gap-3">
          <Link href="/discover" className="text-dark-300 hover:text-white transition-colors">
            <ArrowLeft size={20} />
          </Link>
          ...
          {req.status === 'ACCEPTED' && (
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-dark-800 border border-dark-500 rounded-xl px-4 py-2.5 text-sm text-white placeholder-dark-400 focus:outline-none focus:border-pink-500/40 transition-colors"
              />
              <button
        ...
        <>
            ...
            <div className="space-y-3">
              <div className="relative rounded-xl overflow-hidden aspect-video bg-dark-800">
                ...
                {!showUnlocked && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-2">
                    ...
                    <p className="text-sm font-bold text-white">Pague para desbloquear</p>
              ...
              {!showUnlocked ? (
                <button
                  ...
                  disabled={actionLoading}
                  className="w-full py-3 rounded-xl bg-gold-500 hover:bg-gold-400 text-dark-900 font-bold text-sm flex items-center justify-center gap-2 transition-colors disabled:opacity-50"
                >
          ...
          {req.status === 'PAID' && req.photoUrl && (
            <div className="space-y-3">
              ...
              <button
                onClick={toggleShow}
                className="w-full py-2 rounded-xl border border-dark-500 text-sm text-dark-200 hover:text-white flex items-center justify-center gap-2 transition-colors"
              >
