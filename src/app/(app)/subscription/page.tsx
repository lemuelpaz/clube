        ...
        <div className="max-w-2xl mx-auto flex items-center gap-3">
          {step !== 'plans' && (
            <button
              ...
              className="text-dark-300 hover:text-dark-50 text-sm transition-colors"
            >← Voltar</button>
          )}
      ...
      <div className="max-w-2xl mx-auto p-6 space-y-6">
            ...
            <div>
              ...
              {promo?.valid && (
                <div className="mt-3 bg-dark-800 border border-dark-600 rounded-xl p-3 text-sm space-y-1">
                  ...
                  <div className="flex justify-between font-bold text-dark-50 border-t border-dark-600 pt-1">
                    <span>Total</span>
              ...
              <button onClick={handleGeneratePix} disabled={loading}
                className="w-full mt-4 bg-gold-500 hover:bg-gold-400 disabled:opacity-50 text-dark-50 font-bold py-4 rounded-xl flex items-center justify-center gap-2 gold-glow transition-colors">
                {loading
        ...
        {step === 'done' && (
          <div className="text-center py-12 space-y-4">
            ...
            <a href="/discover"
              className="inline-flex items-center gap-2 bg-gold-500 hover:bg-gold-400 text-dark-50 font-bold px-8 py-3 rounded-xl transition-colors mt-2">
              <Crown size={18} />
              Explorar o Clube
            </a>
          </div>
