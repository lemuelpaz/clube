...
import { STATES, INTERESTS, formatCPF, validateCPF } from '@/lib/utils'
      ...
      <div className="w-full max-w-2xl">
        <div className="glass rounded-2xl p-8 border border-gold-500/10">
          <div className="flex items-center gap-3 mb-6">
            <button onClick={() => setStep('form')} className="text-dark-300 hover:text-white transition-colors">←</button>
            <div>
          ...
          <form onSubmit={handleQuestionnaireSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-dark-800 border border-dark-500 rounded-xl px-4 py-3 text-sm text-white placeholder-dark-300 focus:outline-none focus:border-gold-500/50 transition-colors resize-none"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gold-500 hover:bg-gold-400 disabled:opacity-50 text-dark-900 font-bold py-3.5 rounded-xl transition-colors flex items-center justify-center gap-2"
            >
              {loading ? (
    ...
    <div className="w-full max-w-2xl">
      <div className="glass rounded-2xl p-8 border border-gold-500/10">
        <div className="flex items-center gap-3 mb-8">
          <button onClick={() => setStep('role')} className="text-dark-300 hover:text-white transition-colors">←</button>
          <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              ...
              <input value={form.name} onChange={e => setForm(f => ({ ...f, name: e.target.value }))}
                ...
                className="w-full bg-dark-800 border border-dark-500 rounded-xl px-4 py-3 text-sm text-white placeholder-dark-300 focus:outline-none focus:border-gold-500/50 transition-colors" />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPass ? 'text' : 'password'} value={form.password}
                  ...
                  className="w-full bg-dark-800 border border-dark-500 rounded-xl px-4 py-3 pr-12 text-sm text-white placeholder-dark-300 focus:outline-none focus:border-gold-500/50 transition-colors" />
            ...
            <div>
              ...
              <input type="date" value={form.birthDate} onChange={e => setForm(f => ({ ...f, birthDate: e.target.value }))}
                className="w-full bg-dark-800 border border-dark-500 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-gold-500/50 transition-colors" />
            </div>

            <div>
              <label className="block text-sm font-medium text-dark-100 mb-1.5">Cidade</label>
            ...
            <div>
              <label className="block text-sm font-medium text-dark-100 mb-1.5">Estado</label>
