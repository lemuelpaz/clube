        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className="flex items-center gap-1.5 px-5 py-2 rounded-xl bg-gold-500 hover:bg-gold-400 disabled:opacity-50 text-dark-50 font-bold text-sm transition-colors gold-glow"
            >
              {saving
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="w-28 bg-dark-700 border border-dark-500 focus:border-gold-500 rounded-xl px-3 py-2 text-right font-bold text-lg text-dark-50 outline-none transition-colors"
                    />
                  </div>
                </div>
        ...
        <div className="glass rounded-2xl p-5 border border-dark-600 mt-6">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-dark-300 space-y-1">
              <p className="font-medium text-dark-50">Como funciona</p>
