    ...
    <div className="min-h-screen pb-8">
      <div className="sticky top-0 z-30 bg-dark-900/80 backdrop-blur-lg border-b border-dark-700 px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          {counts.PENDING > 0 && (
            <span className="bg-yellow-500 text-dark-50 text-xs font-bold px-2 py-0.5 rounded-full">{counts.PENDING}</span>
          )}
        </div>
      </div>
                    ...
                    {w.status === 'PENDING' && (
                      <div className="space-y-3">
                        <textarea
                          ...
                          rows={2}
                          className="w-full bg-dark-700 border border-dark-500 rounded-xl px-3 py-2 text-sm text-dark-50 focus:outline-none resize-none"
                        />
