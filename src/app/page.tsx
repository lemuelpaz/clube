    ...
    <div className="min-h-screen bg-dark-900 overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 glass border-b border-gold-500/10">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/login" className="text-sm text-dark-200 hover:text-white transition-colors px-4 py-2">
              Entrar
            </Link>
            <Link href="/register" className="bg-gold-500 hover:bg-gold-400 text-dark-900 text-sm font-semibold px-5 py-2.5 rounded-full transition-colors">
              Cadastrar
            </Link>
          </div>
        </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/register" className="group w-full sm:w-auto bg-gold-500 hover:bg-gold-400 text-dark-900 font-bold px-8 py-4 rounded-full text-base transition-all flex items-center justify-center gap-2 gold-glow">
              Começar Agora
              <ChevronRight size={18} className="group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link href="/login" className="w-full sm:w-auto border border-gold-500/30 hover:border-gold-500/60 text-white px-8 py-4 rounded-full text-base transition-all text-center">
              Já tenho conta
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {[
              ...
              <div key={name} className={`relative p-6 rounded-2xl border transition-all card-hover ${popular ? 'bg-gold-500/10 border-gold-500 gold-glow' : 'bg-dark-800 border-dark-500'}`}>
                ...
                <Link href="/register" className={`mt-6 block text-center py-3 rounded-full text-sm font-bold transition-all ${popular ? 'bg-gold-500 text-dark-900 hover:bg-gold-400' : 'border border-gold-500/40 text-gold-400 hover:border-gold-500'}`}>
                  Assinar
                </Link>
              </div>
            ))}
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link href="/register" className="inline-flex items-center gap-2 bg-gold-500 hover:bg-gold-400 text-dark-900 font-bold px-10 py-4 rounded-full text-base transition-all gold-glow">
      ...
      <footer className="border-t border-dark-600 py-10 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-dark-300">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-white">Clube Elite</span>
          </div>
